  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        ...
        {
          "title": "Request: CURL Templated",
          "content": "curl -H \"Authorization: Bearer $token\" -H \"x-api-key: $api_key\" -X POST -d '{\"options\":{\"layers\":[{<layer_info>}]},\"outputs\":[{\"href\":\"<href>\",\"storage\":\"<storage>\",\"type\":\"<type>\",\"width\":<width>,\"overwrite\":<boolean>},{\"external\":<presigned_putURL>\",\"type\":\"<type>\",\"width\":<width>,\"overwrite\":\"<overwrite>\"}]}' https://image.adobe.io/pie/psdService/documentCreate",
          "type": "curl"
        }
      ]
    },
      ...
      "fields": {
        "Request": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "options.layers.layer.input",
            "description": "<p>An object describing the input file to add or replace for the Embedded Smart Object layer. Currently supported filetypes include:</p> <ul>   <li>ai</li>   <li>jpeg</li>   <li>pdf</li>   <li>png</li>   <li>psb</li>   <li>psd</li>   <li>svg</li> </ul> Added images are always placed at (top,left = 0,0) and bounds are ignored</br> Edited images are replaced for exact pixel size"
          },
          {
            "group": "Request",
            "type": "string",
