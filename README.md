...
1. Only supported for a `Service Integration`: You will have to create your own Service Integration, please refer to [this](https://github.com/AdobeDocs/photoshop-api-docs-pre-release#service-token-workflow-adobe-etla-users) section of the document for details on how to create a Service Integration.
